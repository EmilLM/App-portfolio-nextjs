...
const Project = ({project, active, setCurrentSlide, nextActive, prevActive}) => {
    ...
    return (
        <div id={`${active}${prevActive}${nextActive}`} className={`v4-project-container project-${id}`} onClick={()=>setCurrentSlide(project.id)}>
